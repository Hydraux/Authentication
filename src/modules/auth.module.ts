...
@Module({
    imports: [TypeOrmModule.forFeature([UserEntity]), TypeOrmModule.forFeature([RefreshTokenEntity])],
    ...
    exports: ['RefreshTokenRepository', 'UserRepository', 'TokenGateway', 'CryptoGateway'],
})
